...
class ClaimController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('student.claims.index')->with('success', 'Claim submitted. Staff will review it.');
    }
    ...
    public function destroy(Request $request, Claim $claim): RedirectResponse
    {
        ...
        return redirect()->route('student.claims.index')->with('success', 'Claim deleted successfully.');
    }
}
