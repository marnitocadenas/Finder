...
<section class="landing-hero" style="min-height:auto;padding-bottom:2rem">
    ...
    <div class="container landing-hero-inner" style="padding-top:1rem">
        <div class="landing-hero-copy" style="text-align:left;max-width:100%">
            ...
            <p>No account needed. Submit item details and campus staff will review your report and contact you if a match is found.</p>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="card shadow-sm border-0">
            <div class="card-body p-4 p-md-5">
                <form method="POST" action="{{ route('public.report-lost.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            <label class="form-label" for="date_lost">Date Lost <span class="text-danger">*</span></label>
                            <div class="input-group">
                                <span class="input-group-text"><i class="fa-solid fa-calendar-day"></i></span>
                                <input id="date_lost" class="form-control" type="date" name="date_lost" value="{{ old('date_lost') }}" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="location_lost">Location Lost <span class="text-danger">*</span></label>
                            <div class="input-group">
                                <span class="input-group-text"><i class="fa-solid fa-location-dot"></i></span>
                                <input id="location_lost" class="form-control" name="location_lost" value="{{ old('location_lost') }}" placeholder="Building, room, or area" required>
                            </div>
                        </div>
                        <div class="col-md-6">
